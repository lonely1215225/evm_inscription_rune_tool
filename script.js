...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('a1').style.border = "1px solid #267ad4";
    updateBSection(1);
    ...
    document.querySelectorAll('.b-block').forEach(function (bBlock, index) {
        bBlock.addEventListener('click', function () {
            ...
            bBlock.style.border = "1px solid #267ad4";
        });
    });
});
...
function updateBSection(aIndex) {
    ...
    document.getElementById('a' + aIndex).style.border = "1px solid #267ad4";
}
...
function setTransactionMode(mode) {
    ...
    if (transactionMode === "self") {
        ...
        recipientInput.style.backgroundColor = "#267ad4";
        recipientInput.style.color = "#FFFFFF"; // 文字
    } else if (transactionMode === "other") {
        recipientInput.disabled = false;
        amountInput.style.display = 'block';
        amountLabel.style.display = 'block';
        recipientInput.value = "0xF9C4c674188089A7A5C608510360155147b9607b";
        recipientInput.placeholder = "发送至其他地址";
        selfModeButton.style.backgroundColor = "#2E2E38";
        selfModeButton.style.color = "#FFFFFF";
        otherModeButton.style.backgroundColor = "#267ad4";
        otherModeButton.style.color = "#FFFFFF";
    ...
    try {
        ...
        for (let i = 0; i < nums; i++) {
            ...
            const transaction =
            {
                from: fromAddress,
                to: toAddress,
                value: w3.utils.toWei(amountInput.value, "ether"),
                nonce: nonce + i,
                gas: gas,
